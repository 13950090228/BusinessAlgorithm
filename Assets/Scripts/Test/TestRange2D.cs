...
namespace BusinessAlgorithm.Test {
    public class TestRange2D : MonoBehaviour {
        ...
        public void CustomAction() {
            Clear();
            var result = Range2DAction.GetPosByDirAndDis(drawGraphArgs.pos, drawGraphArgs.angle, drawGraphArgs.radius);
            target.pos = result;
            DrawGraph();
        ...
        public void GetStartCenterToTargetDisWithBodySize() {
            Clear();
            var result = Range2DAction.GetStartCenterToTargetDisWithBodySize(drawGraphArgs.pos, target.pos, target.radius);
        ...
        public void GetStartToTargetDisWithBodySize() {
            Clear();
            var result = Range2DAction.GetStartToTargetDisWithBodySize(drawGraphArgs.pos, caster.radius, target.pos, target.radius);
        ...
        public void CheckTargetInRange() {
            Clear();
            var result = Range2DAction.CheckTargetInRangeWithBodySize(drawGraphArgs.pos, target.pos, target.radius, drawGraphArgs.radius);
        ...
        public void CheckInSectorRangeOfDirectionWithBodySize() {
            Clear();
            var result = Range2DAction.CheckInSectorRangeOfDirectionWithBodySize(drawGraphArgs.pos, target.pos, target.radius, drawGraphArgs.radius, drawGraphArgs.angle, drawGraphArgs.direction);
        ...
        public void CheckInSectorRangeOfDirection() {
            Clear();
            var result = Range2DAction.CheckInSectorRangeOfDirection(drawGraphArgs.pos, target.pos, drawGraphArgs.radius, drawGraphArgs.angle, drawGraphArgs.direction);
        ...
        public void CheckTargetInRectangleWithBodySize() {
            Clear();
            var result = Range2DAction.CheckTargetInRectangleWithBodySize(drawGraphArgs.pos, target.pos, target.radius, drawGraphArgs.direction, drawGraphArgs.length, drawGraphArgs.width, drawGraphArgs.centerRangType);
        ...
        public void CheckTargetInRectangle() {
            Clear();
            var result = Range2DAction.CheckTargetInRectangle(drawGraphArgs.pos, target.pos, drawGraphArgs.direction, drawGraphArgs.length, drawGraphArgs.width, drawGraphArgs.centerRangType);
