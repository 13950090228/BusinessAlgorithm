...
namespace BusinessAlgorithm.Test {
    public class TestRange3D : MonoBehaviour {
        ...
        public void GetStartCenterToTargetDisWithBodySize() {
            Clear();
            var result = Range3DAction.GetStartCenterToTargetDisWithBodySize(drawGraphArgs.pos, target.pos, target.radius);
        ...
        public void GetStartToTargetDisWithBodySize() {
            Clear();
            var result = Range3DAction.GetStartToTargetDisWithBodySize(drawGraphArgs.pos, caster.radius, target.pos, target.radius);
        ...
        public void CheckTargetInRange() {
            Clear();
            var result = Range3DAction.CheckTargetInRangeWithBodySize(drawGraphArgs.pos, target.pos, target.radius, drawGraphArgs.radius);
        ...
        public void CheckInSectorRangeOfDirectionWithBodySize() {
            Clear();
            var result = Range3DAction.CheckInSectorRangeOfDirectionWithBodySize(drawGraphArgs.pos, target.pos, target.radius, drawGraphArgs.radius, drawGraphArgs.angle, drawGraphArgs.direction);
        ...
        public void CheckInSectorRangeOfDirection() {
            Clear();
            var result = Range3DAction.CheckInSectorRangeOfDirection(drawGraphArgs.pos, target.pos, drawGraphArgs.radius, drawGraphArgs.angle, drawGraphArgs.direction);
        ...
        public void CheckTargetInRectangleWithBodySize() {
            Clear();
            var result = Range3DAction.CheckTargetInRectangleWithBodySize(drawGraphArgs.pos, target.pos, target.radius, drawGraphArgs.direction, drawGraphArgs.length, drawGraphArgs.width, drawGraphArgs.centerRangType);
        ...
        public void CheckTargetInRectangle() {
            Clear();
            var result = Range3DAction.CheckTargetInRectangle(drawGraphArgs.pos, target.pos, drawGraphArgs.direction, drawGraphArgs.length, drawGraphArgs.width, drawGraphArgs.centerRangType);
