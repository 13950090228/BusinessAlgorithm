...
namespace BusinessAlgorithm.Easing {
    ...
    public static class EasingFunction {
        ...
        public static float Linear(float t, float b, float c, float d, EasingMode mode) {
            return c * t / d + b;
        }

        public static float Sine(float t, float b, float c, float d, EasingMode mode) {
        ...
        public static float Quad(float t, float b, float c, float d, EasingMode mode) {
            if (mode == EasingMode.EaseIn) {
        ...
        public static float Cubic(float t, float b, float c, float d, EasingMode mode) {
            if (mode == EasingMode.EaseIn) {
        ...
        public static float Quart(float t, float b, float c, float d, EasingMode mode) {
            if (mode == EasingMode.EaseIn) {
        ...
        public static float Quint(float t, float b, float c, float d, EasingMode mode) {
            if (mode == EasingMode.EaseIn) {
        ...
        public static float Expo(float t, float b, float c, float d, EasingMode mode) {
            if (mode == EasingMode.EaseIn) {
        ...
        public static float Circ(float t, float b, float c, float d, EasingMode mode) {
            if (mode == EasingMode.EaseIn) {
        ...
        public static float Back(float t, float b, float c, float d, EasingMode mode) {
            if (mode == EasingMode.EaseIn) {
        ...
        public static float Elastic(float t, float b, float c, float d, EasingMode mode) {
            if (mode == EasingMode.EaseIn) {
        ...
        public static float Bounce(float t, float b, float c, float d, EasingMode mode) {
            if (mode == EasingMode.EaseIn) {
